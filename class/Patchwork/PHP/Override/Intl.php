...
/**/{
        ...
        function grapheme_extract ($s, $size, $type = GRAPHEME_EXTR_COUNT, $start = 0, &$next = 0) {return Patchwork_PHP_Override_Intl::grapheme_extract($s, $size, $type, $start, $next);}
        function grapheme_strlen  ($s) {return Patchwork_PHP_Override_Intl::grapheme_strlen($s);}
        function grapheme_strpos  ($s, $needle, $offset = 0) {return Patchwork_PHP_Override_Intl::grapheme_strpos  ($s, $needle, $offset);}
        function grapheme_stripos ($s, $needle, $offset = 0) {return Patchwork_PHP_Override_Intl::grapheme_stripos ($s, $needle, $offset);}
        function grapheme_strrpos ($s, $needle, $offset = 0) {return Patchwork_PHP_Override_Intl::grapheme_strrpos ($s, $needle, $offset);}
        function grapheme_strripos($s, $needle, $offset = 0) {return Patchwork_PHP_Override_Intl::grapheme_strripos($s, $needle, $offset);}
        function grapheme_stristr ($s, $needle, $before_needle = false) {return Patchwork_PHP_Override_Intl::grapheme_stristr($s, $needle, $before_needle);}
        function grapheme_strstr  ($s, $needle, $before_needle = false) {return Patchwork_PHP_Override_Intl::grapheme_strstr ($s, $needle, $before_needle);}
        function grapheme_substr  ($s, $start, $len = INF) {return Patchwork_PHP_Override_Intl::grapheme_substr($s, $start, $len);}
/**/}
